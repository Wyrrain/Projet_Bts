...
public class Position extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGeoDataClient = (GeoDataClient) Places.getGeoDataClient(this);

        // Construct a PlaceDetectionClient.
        mPlaceDetectionClient = (PlaceDetectionClient) Places.getPlaceDetectionClient(this);
            ...
            if (mLocationPermissionGranted) {
                ...
                locationResult.addOnCompleteListener(this, new OnCompleteListener<Location>() {
                    ...
                    public void onComplete(@NonNull Task<Location> task) {
                        ...
                        //showCoordinates(coordl1, coordl2);
    ...
    private void showCoordinates(){
        Double l1=mLastKnownLocation.getLatitude();
        Double l2=mLastKnownLocation.getLongitude();
        String coordl1 = l1.toString();
        String coordl2 = l2.toString();

        Toast.makeText(this, coordl1 + "," + coordl2, Toast.LENGTH_LONG).show();
    }
